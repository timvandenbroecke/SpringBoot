...
import {CLOTHES} from '../constants/ItemConstants';
...
class Clothes extends Component {
    ...
    componentDidMount(){
        ...
        this.props.getItemsByPagination(0, this.props.pagination.total || 10, "id", CLOTHES);
       ...
       const {store, total_items} = this.props; 
        ...
        return(
            <div className="shop-view">                
             <ShopView store={store || []} total_items={total_items} type={CLOTHES}/>
            </div>
        );
    }
